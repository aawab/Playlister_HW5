...
router.get('/playlistTitles/:title', auth.verify, PlaylistController.searchByTitle)
router.get('/playlistCreators/:username', auth.verify, PlaylistController.searchByCreator)
